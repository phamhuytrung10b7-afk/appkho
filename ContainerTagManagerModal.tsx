...
export const ContainerTagManagerModal: React.FC<ContainerTagManagerModalProps> = ({
  ...
  // Render a single 100mm x 70mm Tag Card based on Factory Standard
  const renderTagCard = (tag: MasterKittingTag, copyIndex?: number) => {
    ...
    return (
      ...
      >
        ...
        {/* 6-Row Grid Table (Strictly bounded 100mm x 70mm layout) */}
        <table
        ...
        >
          ...
          <tbody>
            ...
            {/* Row 2: Tên linh kiện | Value | Quy cách CCDC | Value (Compact & clean) */}
            <tr style={{ height: '12mm' }}>
              ...
              <td
                style={{
                  ...
                  padding: '1.5px 3.5px',
                  fontWeight: 700,
                  fontSize: getCcdcSpecFontSize(displayCcdc),
                  lineHeight: '1.2',
                  wordBreak: 'break-word',
                  color: '#334155',
                }}
            ...
            {/* Row 4: Số lượng | Value (Prominent) | ĐVT | Value */}
  ...
  // Render Back Tag Card (Mặt Sau 100mm x 70mm with 35x35mm QR code centered)
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-200 mt-0.5">
                Kích thước thẻ chuẩn: <strong>100mm x 70mm</strong> (Cắt theo viền đen ngoài cùng). Tối ưu xếp <strong>8 thẻ / 1 trang A4</strong>. In 2 mặt chuẩn khớp.
              </p>
            </div>
          </div>
